...
@Entity
@Table(name = "question_ai_analysis", indexes = {
    @Index(name = "idx_qa_question_created", columnList = "question_id, created_at"),
    @Index(name = "idx_qa_model_name", columnList = "model_name")
})
@Data
@NoArgsConstructor
@AllArgsConstructor
