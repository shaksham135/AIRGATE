-- Flyway Migration V34: Create ai_system_configs table for dynamic AI models & API key configuration
...
INSERT INTO ai_system_configs (config_key, config_value, category, description) VALUES
